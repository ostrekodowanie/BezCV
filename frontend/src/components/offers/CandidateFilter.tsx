    ...
    return (
        <div className="flex flex-col">
            <div className="sticky top-36">
                <input className="px-6 pl-14 py-3 rounded-3xl bg-search bg-[1.4rem_center] w-full bg-no-repeat" value={input} type='search' onChange={e => setInput(e.target.value)} placeholder="Wyszukaj kandydata" />
                <div className="flex flex-col mt-8 gap-8 p-8 bg-white rounded-xl min-h-[80vh] flex-1">
                    <div>
