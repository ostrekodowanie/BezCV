        ...
        <section className="padding pt-[2.2in] sm:pt-[1.4in] xl:pt-[calc(2.2in+3vw)] items-center relative">
            <div className="font-bold bg-secondary rounded-t-3xl px-10 relative xl:px-16 py-8 xl:py-12 pt-12 text-white">
                ...
                <div className="absolute right-10 xl:right-20 bottom-0 hidden xl:block">
                    ...
                    <Control className="absolute top-0 -left-4" onScroll opacity={1} x={20} viewPort={0.5} ease='ease-out' element={<div className="bg-white px-8 py-4 rounded-3xl shadow-[0px_24px_61px_rgba(250,172,62,0.15)]">
                        <h4 className="font-bold xl:text-xl text-font">Dołączysz się?</h4>
                ...
                <div className="absolute xl:w-[26%] w-[2in] left-2 sm:left-8 -top-[1.5in] -z-10 xl:top-auto xl:bottom-[86%] ">
                    ...
                    <Control onScroll opacity={1} x={-20} ease='ease-out' className="absolute -top-[50%] sm:-top-2 -right-[50%] sm:-right-full xl:-right-[60%] max-w-max" element={<div className="bg-white py-3 px-6 rounded-3xl shadow-[0px_24px_61px_rgba(250,172,62,0.15)]">
