    ...
    return (
        <section className="padding pt-[1.4in] md:pt-[2in] pb-16 items-center flex flex-col gap-16 relative text-center overflow-hidden">
            ...
            <div className="flex flex-col md:grid grid-cols-2 gap-8">
                <div className="bg-white p-10 pb-14 flex flex-col gap-6 shadow-primaryBig rounded-3xl relative">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-left">BezCV to portal, który...</h2>
                ...
                <div className="bg-white p-10 pb-14 flex flex-col gap-6 shadow-primaryBig rounded-3xl relative">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-left">Codziennie pozyskujemy...</h2>
