...
export default function HowToFindJob() {
    return (
        <section className="padding py-[1in] md:py-[1.4in] flex flex-col gap-16 xl:grid grid-cols-[3fr_4fr] xl:items-center">
            <div className="flex flex-col gap-4 md:max-w-[50vw]">
                ...
                <Link to='/praca' className="rounded-full max-w-max text-white text-[.8rem] font-semibold flex items-center py-[14px] px-10 mt-6 bg-primary">Opowiedz nam o sobie <img className="ml-2 max-h-[1.2em]" src={arrowRight} alt="" /></Link>
            </div>
            <img src={desktopSurvey} alt="" />
        </section>
    )
}