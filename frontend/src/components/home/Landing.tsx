        ...
        <section className="padding py-[1.4in] md:py-[2in] flex flex-col min-h-screen xl:grid xl:gap-8 xl:items-center grid-cols-[1fr_1fr] relative">
            ...
            <div className="flex flex-col gap-3 xl:mb-8 max-w-[5.8in]">
                ...
                <div className="flex items-center flex-wrap gap-6 mt-6 text-sm font-bold">
                    ...
                    <a href='#zgloszenia' className="py-3 px-6 rounded-full hover:text-secondary transition duration-300 bg-white shadow-[0px_25px_63px_rgba(138,138,138,0.16)] hover:shadow-[0px_38px_69px_rgba(249,141,61,0.14)] flex items-center">Szukam pracy<img className="ml-2 max-h-[1em]" src={orangeArrowRight} alt='' /></a>
                </div>
            </div>
            } />
