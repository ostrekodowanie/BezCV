    ...
    return (
        <section className="padding py-[1.4in] md:py-[2in] flex flex-col xl:grid xl:gap-8 xl:items-center grid-cols-[4fr_3fr]">
            ...
            <div className="flex flex-col gap-3 xl:mb-8 max-w-[5.8in]">
                <h2 className="flex items-center tracking-widest gap-4">
                    <span className="px-2 bg-lightPrimary text-primary rounded-full">BEZCV</span>
                    TO NUMER 1 NA RYNKU OFERT PRACY
                </h2>
                <h1 className="font-bold text-3xl text-font md:text-[2.5rem] xl:text-[min(calc(1rem+2vw),3.4rem)] md:leading-tight">To nie <span className="relative inline-flex items-center">korporacje<div className="bg-primary rounded-full h-[5px] mt-2 -right-2 -left-2 absolute" /></span> tworzą wielkie sukcesy, lecz <span className="relative">ludzie <div className="absolute -z-10 right-0 -left-2 h-[0.6em] rounded-tl-full rounded-br-full rounded-tr rounded-bl bottom-0 bg-[#FEEDE0]" /></span></h1>
