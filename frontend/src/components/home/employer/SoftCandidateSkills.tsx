    ...
    return (
        <section className="padding overflow-hidden relative">
            ...
            <div className="relative py-16 mt-8">
                ...
                <Control className="absolute right-0 h-full bottom-0 -z-10 flex items-end" opacity={1} x={20} ease='ease-out' viewPort={0.6} onScroll element={<img src={bannerMan} alt="" />} />
            </div>
        </section>
    )
}