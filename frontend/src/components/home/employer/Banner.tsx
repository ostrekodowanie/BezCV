    ...
    return (
        <section className="padding pt-[1in] md:pt-[1.4in] 2xl:pt-[1.8in] items-center relative">
            <div className="font-bold flex flex-col gap-6 bg-primary rounded-3xl px-10 overflow relative xl:px-20 py-8 xl:py-16 text-white">
                <h2 className="text-3xl leading-tight xl:text-[2.5rem] xl:leading-tight relative">W BezCV jest ponad <div className="inline-block relative"><CountUp enableScrollSpy useEasing end={500} /><img className="absolute left-0 bottom-1 w-full" src={countUpUnderline} alt='' /></div><br /> kandydatów do pracy</h2>
