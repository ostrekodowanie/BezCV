...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#F6F7F9] padding py-16 flex flex-wrap 2xl:flex md:grid-cols-2 md:grid gap-8 justify-between">
            ...
            <div className="flex flex-col gap-4">
                <button className="bg-white shadow-[0px_12px_45px_rgba(47,102,244,0.06)] rounded-xl px-6 py-3 text-sm font-medium">Facebook</button>
                <button className="bg-white shadow-[0px_12px_45px_rgba(47,102,244,0.06)] rounded-xl px-6 py-3 text-sm font-medium">Instagram</button>
                <button className="bg-white shadow-[0px_12px_45px_rgba(47,102,244,0.06)] rounded-xl px-6 py-3 text-sm font-medium">Twitter</button>
            </div>
        </footer>
    )
}