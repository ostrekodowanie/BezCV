...
urlpatterns = [
    ...
    path('signup/resend', views.ResendEmailView.as_view()),
    ...
    path('profile/followed', views.EmployerProfileFollowedView.as_view()),
    path('profile/purchased', views.EmployerProfilePurchasedView.as_view()),
]